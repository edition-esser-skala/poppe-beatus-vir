...
BeatusViolinoI = {
  \relative c' {
    ...
    e! c f d \tempoBeatusB g\p g g h %15
    c d c c c4 r8 \tempoBeatusC g\fE
    c,4 r8 c\pE \tempoBeatusD a'? f f a?
    b c b b b4 \tempoBeatusE r8 f\fE
